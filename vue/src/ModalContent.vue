...
<template>
        ...
        <div class="im-modal-container fixed inset-0 overflow-y-auto p-4">
            ...
            >
                <div
                    ...
                    :class="['im-modal-wrapper w-full transition-[filter] duration-300', modalContext.onTopOfStack ? '' : 'blur-xs', maxWidthClass]"
                >
                    <div class="im-modal-content relative" :data-inertiaui-modal-entered="entered" :class="[config.paddingClasses, config.panelClasses]">
    ...
    <div v-else-if="isRendered" class="im-modal-container fixed inset-0 z-40 overflow-y-auto p-4" @mousedown.self="handleClickOutside">
        <div
            class="im-modal-positioner flex min-h-full justify-center"
            :class="{
                'items-start': config.position === 'top',
