...
var _sfc_main$4 = {
	...
	setup(__props) {
		...
		onUnmounted(router.on("navigate", ($event) => {
			...
			if (modalStack.stack.value.some((m) => m.response?.component === modalOnBase.component && sameUrlPath(m.response?.url, modalOnBase.url))) return;
			...
			modalStack.pushFromResponseData(modalOnBase, {}, () => {
				...
				modalStack.setBaseUrl(null);
				if (!isNavigating && typeof window !== "undefined" && window.location.href !== modalOnBase.baseUrl) router.visit(modalOnBase.baseUrl, {
					preserveScroll: true,
					preserveState: true
				});
			}).finally(() => {
		...
		watch(() => $page.props?._inertiaui_modal, (newModal, previousModal) => {
			if (!newModal) return;
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock(Fragment, null, [renderSlot(_ctx.$slots, "default"), unref(modalStack).stack.value.length ? (openBlock(), createBlock(_sfc_main$9, {
				key: 0,
				index: 0
...
var setComponentResolver = (_resolver) => {};
var initFromPageProps = (_pageProps) => {};
var Modal = class {
...
function pushFromResponseData(responseData, config = {}, onClose = null, onAfterLeave = null) {
	...
	return router.resolveComponent(responseData.component).then((component) => push(markRaw(component), responseData, config, onClose, onAfterLeave));
}
...
var renderApp = (App, props) => {
	return () => h(_sfc_main$4, () => h(App, props));
};
var withInertiaModal = (app) => {
	const originalRender = app._component.render;
	if (originalRender) app._component.render = () => h(_sfc_main$4, () => originalRender());
};
...
var _sfc_main$1 = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		watch(() => modalContext.value?.onTopOfStack, (onTopOfStack, previousOnTopOfStack) => {
			if (onTopOfStack && !previousOnTopOfStack) emits("focus");
			else if (!onTopOfStack && previousOnTopOfStack) emits("blur");
		});
		watch(() => modalContext.value?.isOpen, (isOpen, previousIsOpen) => {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock(Fragment, null, [unref(modalContext)?.shouldRender ? renderSlot(_ctx.$slots, "default", mergeProps({ key: 0 }, modalProps.value, {
			...
			})) : createCommentVNode("", true), nextIndex.value ? (openBlock(), createBlock(_sfc_main$9, {
				key: 1,
				index: nextIndex.value
			}, null, 8, ["index"])) : createCommentVNode("", true)], 64);
		};
	}
});
//#endregion
...
var _sfc_main$8 = {
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			...
			}, [..._cache[1] || (_cache[1] = [createElementVNode("span", { class: "sr-only" }, "Close", -1), createElementVNode("svg", {
				class: "size-6",
...
var _sfc_main$7 = {
	...
	setup(__props, { emit: __emit }) {
		...
		watch(() => props.modalContext.onTopOfStack, (onTop) => {
			if (props.useNativeDialog) return;
			if (onTop) {
				setupEscapeKey();
		...
		watch(() => props.modalContext.isOpen, (isOpen) => {
		...
		return (_ctx, _cache) => {
			...
			}, [createElementVNode("div", _hoisted_1$2, [createElementVNode("div", { class: normalizeClass(["im-modal-positioner flex min-h-full justify-center", {
			...
			}, [__props.config.closeButton ? (openBlock(), createElementBlock("div", _hoisted_3$1, [createVNode(_sfc_main$8)])) : createCommentVNode("", true), renderSlot(_ctx.$slots, "default", {
				modalContext: __props.modalContext,
				config: __props.config
			})], 10, _hoisted_2$2)], 2)], 2)])], 34)) : isRendered.value ? (openBlock(), createElementBlock("div", {
				key: 1,
			...
			}, [_cache[0] || (_cache[0] = createElementVNode("span", { class: "sr-only" }, "Dialog", -1)), createElementVNode("div", {
				class: normalizeClass(["im-modal-content relative", [__props.config.paddingClasses, __props.config.panelClasses]]),
				"data-inertiaui-modal-entered": entered.value
			}, [__props.config.closeButton ? (openBlock(), createElementBlock("div", _hoisted_5$1, [createVNode(_sfc_main$8)])) : createCommentVNode("", true), renderSlot(_ctx.$slots, "default", {
				modalContext: __props.modalContext,
				config: __props.config
			})], 10, _hoisted_4$1)], 2)], 34)], 32)) : createCommentVNode("", true);
		};
	}
};
//#endregion
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			return __props.useNativeDialog ? (openBlock(), createElementBlock("dialog", {
				...
				onCancel: handleCancel,
				onClick: handleDialogClick
			}, [createElementVNode("div", _hoisted_1$1, [createElementVNode("div", { class: normalizeClass(["im-slideover-positioner flex min-h-full items-center", {
				...
				"data-inertiaui-modal-entered": entered.value
			}, [__props.config.closeButton ? (openBlock(), createElementBlock("div", _hoisted_3, [createVNode(_sfc_main$8)])) : createCommentVNode("", true), renderSlot(_ctx.$slots, "default", {
				modalContext: __props.modalContext,
				config: __props.config
				...
				class: normalizeClass(["im-slideover-content relative", [__props.config.paddingClasses, __props.config.panelClasses]]),
				"data-inertiaui-modal-entered": entered.value
			}, [__props.config.closeButton ? (openBlock(), createElementBlock("div", _hoisted_5, [createVNode(_sfc_main$8)])) : createCommentVNode("", true), renderSlot(_ctx.$slots, "default", {
				modalContext: __props.modalContext,
				config: __props.config
			})], 10, _hoisted_4)], 2)], 34)], 32)) : createCommentVNode("", true);
		};
	}
};
//#endregion
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(_sfc_main$1, {
				...
				default: withCtx(({ afterLeave, close, config, emit, getChildModal, getParentModal, id, index, isOpen, modalContext, onTopOfStack, reload, setOpen, shouldRender, ...props }) => [(openBlock(), createBlock(Teleport, { to: "body" }, [createElementVNode("div", {
					...
					default: withCtx(() => [isOpen ? (openBlock(), createElementBlock("div", _hoisted_2)) : createCommentVNode("", true)]),
					_: 2
				}, 1032, ["appear"])) : createCommentVNode("", true), (openBlock(), createBlock(resolveDynamicComponent(config?.slideover ? _sfc_main$6 : _sfc_main$7), {
					...
					default: withCtx(() => [renderSlot(_ctx.$slots, "default", mergeProps(props, {
						id,
						afterLeave,
						close,
						config,
...
var _sfc_main$3 = {
	...
	setup(__props, { emit: __emit }) {
		...
		watch(() => modalContext.value?.onTopOfStack, (onTopOfStack) => {
		...
		function handle() {
			...
			modalStack.visit(props.href, props.method, props.data, props.headers, rejectNullValues(only(props, modalPropNames)), onClose, onAfterLeave, props.queryStringArrayFormat, shouldNavigate.value).then((context) => {
				modalContext.value = context;
			}).catch((error) => {
				console.error(error);
				emit("error", error);
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(resolveDynamicComponent(__props.as), mergeProps(unref($attrs), {
				...
				default: withCtx(() => [renderSlot(_ctx.$slots, "default", { loading: loading.value })]),
				_: 3
			}, 16, ["href"]);
		};
	}
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(resolveDynamicComponent(props.as), {
				...
				default: withCtx(() => [loaded.value ? renderSlot(_ctx.$slots, "default", { key: 0 }) : renderSlot(_ctx.$slots, "fallback", { key: 1 })]),
				_: 3
			}, 512);
		};
	}
...
//#endregion
export { _sfc_main as Deferred, _sfc_main$1 as HeadlessModal, _sfc_main$2 as Modal, Modal as ModalInstance, _sfc_main$3 as ModalLink, _sfc_main$4 as ModalRoot, _sfc_main$5 as WhenVisible, dialogUtils, getConfig, initFromPageProps, modalPropNames, prefetch, putConfig, renderApp, resetConfig, useModal, useModalStack, visitModal, withInertiaModal };
