...
Another great example is reloading the parent modal when the child modal is closed. This is described in the [Reload Props](/v0/reload-props#example-with-nested-stack-modal) documentation.
