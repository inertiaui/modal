...
If you need more refined control over the mounting process, contrary to the regular [Inertia.js installation](/v0/installation#inertia-js-configuration), you may ignore the `renderApp` helper method and perform the mounting manually.
