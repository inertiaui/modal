...
The `reload` function is great to combine with [nested modals](/v0/nested-stacked-modals). For example, you can reload the parent modal when the child modal is closed:
