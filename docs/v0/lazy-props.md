...
Then in the frontend, you can use the `reload` method to load the lazy prop. For a deeper dive into how reload works, check out the [Reload Props](/v0/reload-props) documentation.
